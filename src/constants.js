...
{ name: 'Instagram', url: 'https://img.icons8.com/doodle/40/000000/instagram-new--v2.png', link: 'https://www.instagram.com/vijay._.97/' },
{ name: 'Github', url: 'https://img.icons8.com/doodle/40/000000/github--v1.png', link :'https://github.com/vijay0772'},
{ name: 'LinkedIn', url: 'https://img.icons8.com/doodle/40/000000/linkedin--v2.png', link: 'https://www.linkedin.com/in/vijay-bharvad-a44085210/'}
]
...
export const serviceData = [
  {
    ...
    desc: 'I provide comprehensive web design services, covering a wide range of skills and disciplines essential for creating and maintaining websites. My expertise includes web graphic design, user interface design, authoring with standardized code and proprietary software, user experience design, and search engine optimization.',
  ...
  },
  {
    ...
    desc: `I offer a variety of mobile application development services, including custom mobile development for Android platforms, building cross-platform apps, designing user experiences, and integrating innovative mobile interfaces such as chat and voice functionalities. `,
...

  {
    ...
    desc: `My backend development services focus on crafting professional visual content to communicate messages effectively. By applying visual hierarchy and page layout techniques, I ensure that typography and images are used to meet users' specific needs, optimizing the logic of displaying elements in interactive designs to enhance the user experience.`,
